...
`;const Ee={solar:{x:250,y:44},inverter:{x:250,y:175},battery:{x:74,y:175},home:{x:426,y:175},grid:{x:250,y:308}};function Ce(e,t=1){return Math.abs(e)>=1e3?`${(e/1e3).toFixed(t)} kW`:`${Math.round(e)} W`}function Se(e){const{config:t,solarWatts:i,batteryWatts:a,gridWatts:r,loadWatts:o,batterySoc:n,operatingMode:s,isFault:l,onNodeClick:c}=e,d=t.max_power||4200,p=!1!==t.use_log_flow_model,h=t.min_flow_rate||.75,g=t.max_flow_rate||5,_=function(e,t,i,a,r){const o=[],n=r?.solar||be,s=r?.battery_charge||fe,l=r?.battery_discharge||ve,c=r?.grid_import||xe,d=r?.grid_export||we,p=r?.home||$e,h=Math.max(0,e);h>=5&&o.push({id:"flow-solar-inverter",d:"M 250 82 L 250 140",watts:h,color:n,reversed:!1});const g=Math.max(0,a);g>=5&&o.push({id:"flow-inverter-home",d:"M 284 175 L 388 175",watts:g,color:p,reversed:!1});const _=Math.abs(t);if(_>=5){const e=t>0;o.push({id:"flow-battery-inverter",d:"M 116 175 L 216 175",watts:_,color:e?s:l,reversed:e})}const u=Math.abs(i);if(u>=5){const e=i>0;o.push({id:"flow-grid-inverter",d:"M 250 210 L 250 274",watts:u,color:e?c:d,reversed:e})}return o}(i,a,r,o,t.colors),{solar:u,inverter:y,battery:m,home:b,grid:f}=Ee,v=Math.max(0,Math.min(100,isNaN(n)?0:n)),x=2*Math.PI*32,w=x*(1-v/100),$=v>50?"#10b981":v>20?"#f59e0b":"#ef4444",k=a>20?"Charge":a<-20?"Discharge":"Standby";return W`
    <div class="power-flow-container">
      ...
      <svg class="flow-svg" viewBox="0 0 500 360" preserveAspectRatio="xMidYMid meet">
        ...
        ${_.map(e=>{const t=function(e,t=4200,i=.75,a=5,r=!0){const o=Math.abs(e);if(o<5)return 0;const n=Math.min(o,t);let s;s=r?Math.log10(n+1)/Math.log10(t+1):n/t;const l=a-s*(a-i);return Math.max(i,Math.min(a,Number(l.toFixed(2))))}(e.watts,d,h,g,p),i=function(e,t=4200){const i=Math.min(Math.abs(e)/t,1);return Number((2.8+2.7*i).toFixed(1))}(e.watts,d);return j`
            <path
              id="${e.id}"
      ...
      <div class="flow-nodes-layer">
        ...
        >
          ...
          <span class="node-value">${Ce(i)}</span>
        ...
        >
          ...
          <span class="node-value">${Ce(o)}</span>
        ...
        >
          ...
          <span class="node-value">${Ce(Math.abs(r))}</span>
  ...
  `}function Ne(e,t){if(!e||e.length<2)return W`<div class="sparkline-placeholder"></div>`;const i=Math.min(...e),a=Math.max(...e)-i||1,r=e.map((t,r)=>{const o=r/(e.length-1)*110,n=26-(t-i)/a*20-3;return`${o.toFixed(1)},${n.toFixed(1)}`}).join(" ");return j`
  ...
  `}function Me(e){const{config:t,batteryVoltage:i,batteryCurrent:a,gridVoltage:r,gridImportEnergyToday:o,loadEnergyToday:n,historyMap:s,onParamClick:l}=e;let c="#10b981";null===i||isNaN(i)||(i<24||i>29?c="#ef4444":i<25.6&&(c="#f59e0b"));let d="#4285f4",p="Normal";null===r||isNaN(r)||(r<190||r>255?(d="#ef4444",p=r<190?"Low (Sag)":"High (Surge)"):(r<210||r>245)&&(d="#f59e0b",p="Deviated"));let h=100;if(null!==n&&n>0){const e=null!==o?Math.max(0,o):0;h=Math.max(0,Math.min(100,Math.round(100*(1-e/n))))}const g=h>=75?"#10b981":h>=40?"#f59e0b":"#ef4444",_=s.get("battery_voltage")||[],u=s.get("grid_voltage")||[];return W`
  ...
  `}({config:this._config,operatingMode:l,temperature:c,isCharging:d,isFault:p,faultCode:h,isWarning:g,warningCode:_,onChipClick:e=>this._handleEntityClick(e)}):""}
        ...
        ${!1!==this._config.show_alerts&&A?function(e){const{safetyConfig:t,isFault:i,faultCode:a,isWarning:r,warningCode:o,onAlertClick:n}=e;if(!i&&!r)return W``;const s=a??0,l=Pe[s]||{title:`Код сбоя F${s}`,description:"Обнаружена аппаратная или программная ошибка инвертора.",recommendation:"Проверьте сообщения на дисплее инвертора и документацию."},c=o??0,d=Oe[c]||{title:`Предупреждение W${c}`,description:"Инвертор зафиксировал отклонение параметров от нормы."};return W`
  ...
  `}({safetyConfig:A,isFault:p,faultCode:h,isWarning:g,warningCode:_,onAlertClick:e=>this._handleEntityClick(e)}):""}
        ...
        ${!1!==this._config.show_params?Me({config:this._config,batteryVoltage:r,batteryCurrent:o,gridVoltage:n,gridImportEnergyToday:u,loadEnergyToday:y,historyMap:this._historyMap,onParamClick:e=>this._handleEntityClick(e)}):""}

        <!-- 5. BMS Redodo LiFePO4 Cell Telemetry & Balancing (Single or Dual Battery Series) -->
        ${!1!==this._config.show_bms&&f?function(e){const{bmsConfig:t,isDual:i,battery1:a,battery2:r,soc:o,temperature:n,cycleCount:s,remainingCapacity:l,fullCapacity:c,cellDelta:d,cells:p,onBmsClick:h}=e,g=3.65-3;if(i&&a&&r){const e=a.voltage??0,t=r.voltage??0,i=e>0&&t>0?Math.round(1e3*Math.abs(e-t)):0;let o="#10b981",n="Баланс в норме";i>200?(o="#ef4444",n="Разбаланс пачек!"):i>80&&(o="#f59e0b",n="Дрейф пачек");const s=[...a.cells,...r.cells].map(e=>e.voltage).filter(e=>e>0),l=s.length>0?Math.min(...s):3,c=s.length>0?Math.max(...s):3.65,d=s.length>0?Math.round(1e3*(c-l)):0;return W`
      <div class="bms-card-section dual-bms-section">
        ...
        <div class="bms-header">
          ...
          <div class="bms-header-status">
            ...
            <span
              ...
              style="--delta-color: ${o}"
              title="Разница напряжений между батареями: ${n}"
            >
              <ha-icon icon="mdi:scale-balance"></ha-icon>
              <span>Δ Пачек: ${i} mV</span>
            </span>

            <!-- Cell delta badge -->
            <span
              class="bms-delta-pill cell-delta-pill"
              style="--delta-color: ${d>40?"#f59e0b":"#10b981"}"
              title="Разница между лучшей и худшей ячейкой"
            >
              <span>Δ Ячеек: ${d} mV</span>
            </span>
          </div>
        </div>
        ...
        ${i>150?W`
              <div class="series-drift-alert">
                <ha-icon icon="mdi:alert"></ha-icon>
                <span>
                  Зафиксирована разница между батареями ${i} mV (АКБ 1: ${e.toFixed(2)}V, АКБ 2: ${t.toFixed(2)}V).
        ...
        <div class="dual-battery-container">
          ...
          <div class="pack-column">
            ...
            <div class="cells-grid pack-cells" role="group" aria-label="${a.name} Cells">
              ${a.cells.map(e=>{const t=e.voltage===l&&s.length>1,i=e.voltage===c&&s.length>1,a=Math.max(15,Math.min(100,Math.round((e.voltage-3)/g*100))),r=i?"#10b981":t?"#3b82f6":"#0ea5e9";return W`
                  <div
                    class="cell-col"
          ...
          <div class="pack-column">
            ...
            <div class="cells-grid pack-cells" role="group" aria-label="${r.name} Cells">
              ${r.cells.map(e=>{const t=e.voltage===l&&s.length>1,i=e.voltage===c&&s.length>1,a=Math.max(15,Math.min(100,Math.round((e.voltage-3)/g*100))),r=i?"#10b981":t?"#3b82f6":"#0ea5e9";return W`
                  <div
                    class="cell-col"
                    @click=${()=>h(e.rawEntityId)}
                    title="Ячейка #${e.index}: ${e.voltage.toFixed(3)} V ${i?"(MAX)":t?"(MIN)":""}"
    ...
    `}const _=p.map(e=>e.voltage).filter(e=>e>0),u=_.length>0?Math.min(..._):3,y=_.length>0?Math.max(..._):3.65,m=null===d||isNaN(d)?_.length>0?Math.round(1e3*(y-u)):0:d;let b="#10b981",f="Balanced";return m>50?(b="#ef4444",f="Imbalance Alert"):m>20&&(b="#f59e0b",f="Normal Drift"),W`
    <div class="bms-card-section">
      ...
      <div class="bms-header">
        <div class="bms-header-title">
          ...
          ${null===o||isNaN(o)?"":W`<span class="bms-soc-badge">${Math.round(o)}% SOC</span>`}
        </div>
      ...
      <div class="bms-body">
        ...
        <div class="cells-grid" role="group" aria-label="LiFePO4 Cell Voltages">
          ${p.map(e=>{const t=e.voltage===u&&_.length>1,i=e.voltage===y&&_.length>1,a=Math.max(15,Math.min(100,Math.round((e.voltage-3)/g*100))),r=i?"#10b981":t?"#3b82f6":"#0ea5e9";return W`
              <div
                class="cell-col"
                @click=${()=>h(e.rawEntityId)}
                title="Ячейка #${e.index}: ${e.voltage.toFixed(3)} V ${i?"(MAX)":t?"(MIN)":""}"
          ...
          ${null===n||isNaN(n)?"":W`
                ...
                >
                  ...
                  <div class="bms-stat-text">
                    <span class="bms-stat-val">${n.toFixed(1)}°C</span>
  ...
  `}({bmsConfig:f,isDual:v,battery1:x,battery2:w,soc:s,temperature:f.temperature_entity?this._getNumber(f.temperature_entity):null,temperature2:f.temperature_2_entity?this._getNumber(f.temperature_2_entity):null,cycleCount:f.cycle_count_entity?this._getNumber(f.cycle_count_entity):null,remainingCapacity:f.remaining_capacity_entity?this._getNumber(f.remaining_capacity_entity):null,fullCapacity:f.full_capacity_entity?this._getNumber(f.full_capacity_entity):null,cellDelta:f.cell_delta_entity?this._getNumber(f.cell_delta_entity):null,cells:$,onBmsClick:e=>this._handleEntityClick(e)}):""}
        ...
        ${!1!==this._config.show_controls&&k?function(e){const{controlsConfig:t,expanded:i,onToggleExpand:a,chargeSource:r,chargeSourceOptions:o,outputPriority:n,outputPriorityOptions:s,maxChargeCurrent:l,bulkVoltage:c,floatVoltage:d,isEqualization:p,onSelectOption:h,onSetNumber:g,onToggleSwitch:_}=e;return W`
